...
const DeliveryDetails = () => {
  ...
  return (
    <View style={[styles.deliveryDetails, styles.rectangleBg]}>
      <View style={[styles.header, styles.headerPosition]}>
        <View style={[styles.background, styles.headerPosition]} />
        <Text style={styles.deliveryDetails1}>Delivery Details</Text>
        <Image
        ...
        <Pressable
          style={[styles.leftArrow12, styles.icMoreIconLayout]}
      ...
      <View style={[styles.backdropParent, styles.backdropPosition]}>
        ...
        <Image
          ...
          contentFit="cover"
          source={require("../assets/frame-108191.png")}
        />
        <View style={styles.groupParent}>
          <View style={styles.groupWrapper}>
            <View style={styles.enterPickupAndDropoffParent}>
              <Text style={[styles.enterPickupAnd, styles.hClr]}>
                Enter Pickup and Dropoff
              </Text>
              <View style={[styles.rectangle, styles.rectangleShadowBox]} />
              <Image
                style={[styles.iconsdropdowntransfer, styles.iconLayout]}
                contentFit="cover"
                source={require("../assets/iconsdropdowntransfer2.png")}
              />
          ...
          <View style={styles.avatardefaultParent}>
            <Image
              style={[styles.avatardefaultIcon, styles.iconLayout]}
              contentFit="cover"
          ...
          <View style={[styles.documents, styles.documentsLayout]}>
            ...
            <View style={[styles.documentsInner, styles.deliveryBox13Layout]}>
              <View style={[styles.fileParent, styles.parentFlexBox]}>
                ...
                />
                <Text style={styles.documents1}>Receipt</Text>
              </View>
            </View>
          </View>
          <View style={styles.headingToTheCityWrapper}>
            <Pressable
              style={styles.headingToTheContainer}
              onPress={() => navigation.navigate("RateRider")}
            >
              <Text style={[styles.rateRider, styles.textSpaceBlock]}>
                Rate Rider
              </Text>
            </Pressable>
          </View>
          ...
          <View style={styles.groupContainer}>
            <View
              style={[styles.headingToTheCityParent, styles.headingPosition]}
            >
...
const styles = StyleSheet.create({
  ...
  headingToTheContainer: {
    left: "0%",
    top: "50%",
    position: "absolute",
  },
  headingToTheCityWrapper: {
    marginTop: 19.5,
    width: "24.48%",
    right: "43.58%",
    left: "31.94%",
